...
def EventReportCreated(*args, **kwargs):
    ...
    return Event(
        ...
        message=f'{report.reported_by} submitted this report.',
...
def EventReportResponded(*args, **kwargs):
    ...
    return Event(
        ...
        message=f'{response.responder} responded to this report as {response.sender}',
        details={'report': report.to_dict(), 'response': response.to_dict()},
    )
...
def EventAttributeChanged(*args, **kwargs):
    ...
    return Event(
        ...
        message=f'{creator} has changed the {attr} of this report to {value}',
        details={'attr': attr, 'value': value, 'report': report.to_dict()},
    )
...
def EventRuleMatch(*args, **kwargs):
    ...
    return Event(
        ...
        message=f'Rule {rule.name} matched this report.',
        details={'rule': rule.to_dict(), 'report': report.to_dict()},
    )
